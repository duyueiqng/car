...
<head>
    <title>每月应还汽车</title>
	 ...
	 <script type="text/javascript">
	  ...
	  //tableid
	  	window.location.href = "car/statistics/getOneStati?tableid="+tableId;
	  }
	</script>
  </head>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td bgcolor="#f3ffe3"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#c0de98" onmouseover="changeto()"  onmouseout="changeback()">
          ...
          <c:forEach var="rent" items="${allStati}"  varStatus="s">
    		 ...
    		 <td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE1">
              <input name="dels" type="checkbox" class="STYLE2" value="checkbox" />
               ...
               <td height="18" bgcolor="#FFFFFF" class="STYLE2"><div align="center" class="STYLE2 STYLE1">${s.count }</div></td>
    			...
    			<td height="18" bgcolor="#FFFFFF"><div align="center"><img src="images/037.gif" width="9" height="9" /><span class="STYLE1"> [</span><a onclick="preUpdate('${rent.tableid }')" style="font-size: 10px; cursor: hand; color: blue; ">查看</a><span class="STYLE1">]</span></div></td>
    		</tr>
    	</c:forEach>
        </table></td>
